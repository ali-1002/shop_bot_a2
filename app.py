...
async def on_startup(dispatcher):
    ...
    #bot ishga tushgani haqida adminga habar berish
    await on_startup_notify(dispatcher)

    #Database ishlatish
    await db.conf()

    #User jadvali yo'q bo'lsa yaratish
    ...
    #                    ('phone', '📱⌚️ 🎧 Smartfon, telefon, gadjet, aksessuarlar'),
